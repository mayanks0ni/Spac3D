...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (file) {
                ...
                setPreview(url);
                return ({
                    "Home.useEffect": ()=>URL.revokeObjectURL(url)
                })["Home.useEffect"];
            }
        }
    }["Home.useEffect"], [
    ...
    const processImage = async ()=>{
        ...
        try {
            ...
            const apiUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || "http://127.0.0.1:8000";
            let res;
            try {
...
_s(Home, "CmTnfjfKEb23ch6EpoUAHWR7qg4=", false, function() {
    return [
